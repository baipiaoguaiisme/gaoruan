...
class DataProcess:
    ...
    def get_ques_skill_mat(self):
        ...
        ques_skill_mat = np.zeros(shape=(num_ques, num_skill), dtype=np.int32)
...
if __name__ == '__main__':
    t = time.time()
    dataPath = r'C:\Users\perper\Downloads\assistments_2009_2010 (1)\skill_builder_data_corrected_collapsed.csv'
    saveFolder = r'.'
